...
public class ResourcePackManifest
{
    ...
    public object FormatVersion { get; set; }
    ...
    public List<Subpack> Subpacks { get; set; }
    ...
    public class HeaderEntry
    {
        ...
        [JsonPropertyName("pack_scope")]
        public string PackScope { get; set; }
        ...
        public string Version
        {
            get
            {
                ...
                else if (VersionElement.ValueKind == JsonValueKind.Array)
                {
        ...
        public string MinEngineVersion
        {
            get
            {
                ...
                else if (MinEngineVersionElement.ValueKind == JsonValueKind.Array)
                {
    ...
    public class Subpack
    {
        ...
        public int Tier
        {
            get
            {
                ...
                else if (MemoryPerformanceTierElement.ValueKind == JsonValueKind.String)
                {
                    if (int.TryParse(MemoryPerformanceTierElement.GetString(), out int result))
                        return result;
                }
                ...
                {
                    if (int.TryParse(MemoryTierElement.GetString(), out int result))
                        return result;
                }
                return 0;
            }
