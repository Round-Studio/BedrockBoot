...
namespace BedrockBoot.Base.Entry
{
    public class ConfigEntry
    {
        ...
        [JsonPropertyName("gameFolderSelIndex")]
        public int GameFolderSelIndex { get; set; } = -1;

        [JsonPropertyName("downloadChunkCount")]
        public int DownloadChunkCount { get; set; } = 4;

        [JsonPropertyName("versionSourceIndex")]
        public int VersionSourceIndex { get; set; } = 0;

        [JsonPropertyName("curseForgeSourceIndex")]
        public int CurseForgeSourceIndex { get; set; } = 0;
        ...
        [JsonPropertyName("isAutoCheckUpdate")]
        ...
        [JsonPropertyName("isUseHardwareDecode")]
        public bool IsUseHardwareDecode { get; set; } = true;

        [JsonPropertyName("isPlayBackgroundMusic")]
        public bool IsPlayBackgroundMusic { get; set; } = true;

        [JsonPropertyName("isEnableFuzzySearch")]
        public bool IsEnableFuzzySearch { get; set; } = true;
        ...
        [JsonPropertyName("isolationPriority")]
        public IsolationModelEnum IsolationPriority { get; set; } = IsolationModelEnum.Plus;

        [JsonPropertyName("catalogStrategy")]
        public CatalogStrategyEnum CatalogStrategy { get; set; } = CatalogStrategyEnum.Independence;
        ...
        [JsonPropertyName("isShowConnectPage")]
        public bool IsShowConnectPage { get; set; } = false;

        [JsonPropertyName("isChooseAccountBeforeLaunch")]
        public bool IsChooseAccountBeforeLaunch { get; set; } = false;

        [JsonPropertyName("isOpenGameLayering")]
        public bool IsOpenGameLayering { get; set; } = true;

        [JsonPropertyName("isUseMultipleUsers")]
        public bool IsUseMultipleUsers { get; set; } = false;
        ...
        [JsonPropertyName("isMouseLockForGdk")]
        public bool IsMouseLockForGdk { get; set; } = false;

        [JsonPropertyName("isMouseLockReserve")]
        public bool IsMouseLockReserve { get; set; } = false;

        [JsonPropertyName("mouseLockWindowTrimming")]
        public int MouseLockWindowTrimming { get; set; } = 2;

        [JsonPropertyName("isMouseLockGetFrame")]
        public bool IsMouseLockGetFrame { get; set; } = true;

        [JsonPropertyName("mouseLockHotkey")] public string MouseLockHotkey { get; set; } = "Ctrl+Alt";

        [JsonPropertyName("isUseSystemWindow")]
        public bool IsUseSystemWindow { get; set; } = false;

        [JsonPropertyName("isRightLaunchButton")]
        public bool IsRightLaunchButton { get; set; } = false;

        [JsonPropertyName("launchBehavior")]
        public LaunchBehaviorEnum LaunchBehavior { get; set; } = LaunchBehaviorEnum.Normal;
        ...
        [JsonPropertyName("launchCommandConfig")]
    ...
    public class LaunchCommandConfig
    {
        ...
        [JsonPropertyName("isWaitForPreLaunch")]
        public bool IsWaitForPreLaunch { get; set; } = true;

        [JsonPropertyName("preLaunchTimeout")] public int PreLaunchTimeout { get; set; } = 30;

        [JsonPropertyName("isAbortOnPreLaunchFailure")]
        public bool IsAbortOnPreLaunchFailure { get; set; } = false;
    }

    public class PublicOptionsConfig
    {
        [JsonPropertyName("pubOptionsInstance")]
        public string? PubOptionsInstancePath { get; set; } = string.Empty;
    ...
    public class StyleConfig
    {
        ...
        [JsonPropertyName("selectThemePackHash")]
        public string SelectThemePackHash { get; set; } = string.Empty;
        ...
        [JsonPropertyName("backgroundImageBlur")]
        public int BackgroundImageBlur { get; set; } = 1;

        [JsonPropertyName("backgroundAnimation")]
        ...
        public MediaSourceEnum MediaSource { get; set; } = MediaSourceEnum.PriorityThemePack;
        ...
        [JsonPropertyName("micaType")] public MicaType MicaType { get; set; } = MicaType.MicaAlt;
    }
