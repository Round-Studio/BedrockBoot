...
namespace BedrockBoot.Inject
{
	public static class Native
	{
		...
		public static unsafe void Init(byte[] bytes)
		{
		...
		public static unsafe void LoadPlugins(int targetPid, string dll_path, bool delay_inject, int time_ms)
		{
			...
			delegate* unmanaged[Cdecl]<int, void*, bool, int, int> func = (delegate* unmanaged[Cdecl]<int, void*, bool, int, int>)ptr;
			IntPtr address = Marshal.StringToHGlobalAnsi(dll_path);
