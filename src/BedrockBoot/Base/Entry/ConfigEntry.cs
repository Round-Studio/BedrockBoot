...
public class ConfigEntry
{
    ...
    public int VersionSourceIndex { get; set; } = 3;
    ...
    [JsonPropertyName("isAutoCacheGamePack")]
    public bool IsAutoCacheGamePack { get; set; } = true;
...
public class StyleConfig
{
    ...
    [JsonPropertyName("backgroundImageSelectedIndex")]
    public int BackgroundImageSelectedIndex { get; set; } = -1;
