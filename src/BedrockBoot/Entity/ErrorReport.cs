...
public class ErrorReport
{
    ...
    [JsonPropertyName("bbVersion")] public string BBVersion { get; set; }

    [JsonPropertyName("errorTitle")] public string ErrorTitle { get; set; }

    [JsonPropertyName("exceptionCanInfo")] public ExceptionCanInfo ExceptionCanInfo { get; set; }

    [JsonPropertyName("exceptionInfo")] public ExceptionInfo ExceptionInfo { get; set; }

    [JsonPropertyName("networkInfo")] public NetworkInfo NetworkInfo { get; set; }

    [JsonPropertyName("configInfo")] public object ConfigInfo { get; set; }
...
{
    [JsonPropertyName("errorTime")] public string ErrorTime { get; set; }
...
public class ExceptionInfo
{
    ...
    public static ExceptionInfo Create(string message, Exception exception)
    {
        ...
        if (exception != null)
        {
            ...
            if (string.IsNullOrEmpty(message)) info.Message = exception.Message;
        }
        else
        {
            info.InnerException = "-";
...
{
    [JsonPropertyName("networkStatus")] public bool NetworkStatus { get; set; }

    [JsonPropertyName("pcNetworkInterface")]
    public string PCNetworkInterface { get; set; }

    [JsonPropertyName("interfaceName")] public string InterfaceName { get; set; }

    [JsonPropertyName("interfaceDescription")]
    public string InterfaceDescription { get; set; }

    [JsonPropertyName("wireless")] public string Wireless { get; set; }

    [JsonPropertyName("proxyStatus")] public bool ProxyStatus { get; set; }
