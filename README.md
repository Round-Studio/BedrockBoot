...
| 多账户管理，切换   | ✅️           | 在 Windows 与 Linux 平台均已支持在启动器内登录 XBOX 账户以及切换游戏使用的账户，并进行线上游戏模式                                 |
...
| LeviLamina         | ✅️           | 支持在实例中安装，管理，加载 LeviLamina 及其模组                                                                                   |
| DllMods            | ✅️           | 支持在启动器内安装，下载，管理和启动各种 DllMod                                                                                    |
