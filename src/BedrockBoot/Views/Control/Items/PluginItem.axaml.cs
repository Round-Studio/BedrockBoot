...
public partial class PluginItem : UserControl
{
    ...
    public PluginItem(PackConfig info) : this()
    {
        ...
        EnableSwitch.IsCheckedChanged += (s, e) =>
        {
            ...
            bool isChecked = EnableSwitch.IsChecked ?? false;
        ...
        DeleteButton.Click += (s, e) =>
        {
            DialogHost.Show(new DialogInfo()
            {
                ...
                CloseAction = () =>
                {
                    ...
                    {
                        var manager = this.FindAncestorOfType<BedrockBoot.Views.Pages.SettingSubPage.SettingPluginPages.PluginManager>();
                        manager?.UpdateUI();
                    }
                }
            });
