    ...
    public static class AppUpdater
    {
        ...
        private static void LaunchUpdateReplacement(string targetExePath)
        {
            try
            {
                ...
                ProcessStartInfo replaceInfo = new ProcessStartInfo
                {
        ...
        private static void PerformFileReplacement(string oldExePath)
        {
            try
            {
                ...
                {
                    // 关键步骤4：启动更新后的程序
                    ProcessStartInfo finalStartInfo = new ProcessStartInfo
                    {
                        FileName = oldExePath,
